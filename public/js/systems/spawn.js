...
class SpawnSystem {
    constructor(game) {
        ...
        this.difficultySystem = {
            // 30초마다 적 출현 빈도 증가 (초당 1마리씩, 기본값 2.0)
            spawnRatePhases: [
                { time: 0, rate: 2.0 },      // 0-30초: 초당 2.0마리
                { time: 30, rate: 3.0 },     // 30-60초: 초당 3.0마리
                { time: 60, rate: 4.0 },     // 1-1.5분: 초당 4.0마리
                { time: 90, rate: 5.0 },     // 1.5-2분: 초당 5.0마리
                { time: 120, rate: 6.0 },    // 2-2.5분: 초당 6.0마리
                { time: 150, rate: 7.0 },    // 2.5-3분: 초당 7.0마리
                { time: 180, rate: 8.0 },    // 3-3.5분: 초당 8.0마리
                { time: 210, rate: 9.0 },    // 3.5-4분: 초당 9.0마리
                { time: 240, rate: 10.0 },   // 4-4.5분: 초당 10.0마리
                { time: 270, rate: 11.0 },   // 4.5-5분: 초당 11.0마리
                { time: 300, rate: 12.0 },   // 5-5.5분: 초당 12.0마리
                { time: 330, rate: 13.0 },   // 5.5-6분: 초당 13.0마리
                { time: 360, rate: 14.0 },   // 6-6.5분: 초당 14.0마리
                { time: 390, rate: 15.0 },   // 6.5-7분: 초당 15.0마리
                { time: 420, rate: 16.0 },   // 7-7.5분: 초당 16.0마리
                { time: 450, rate: 17.0 },   // 7.5-8분: 초당 17.0마리
                { time: 480, rate: 18.0 },   // 8-8.5분: 초당 18.0마리
                { time: 510, rate: 19.0 },   // 8.5-9분: 초당 19.0마리
                { time: 540, rate: 20.0 }    // 9분+: 초당 20.0마리 (최종 구간)
            ],
        ...
        // 스폰 설정
        this.spawnConfig = {
            baseSpawnRate: 2.0,        // 기본 스폰률 (초당) - 0.x초마다 1마리씩 등장
    ...
    updateDifficulty() {
        ...
        if (Math.floor(currentTime) % 30 === 0 && Math.floor(currentTime) > 0) {
            ...
            console.log(`   📈 스폰 레이트: ${currentSpawnRate.toFixed(1)}/초 (${this.spawnInterval.toFixed(3)}초마다 1마리)`);
